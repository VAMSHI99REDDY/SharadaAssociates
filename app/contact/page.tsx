        ...
        <div className="container-max">
          <div className="premium-card p-8 md:p-12 text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              <a href="https://wa.me/919985111136?text=Hello%20Sharada%20Associates,%20I%20would%20like%20to%20know%20more%20about%20Education%20Loans%20and%20Admission%20Assistance." target="_blank" rel="noreferrer" className="btn-outline flex items-center gap-2 border-emerald-500 text-emerald-600 hover:bg-emerald-50" style={{ background: "var(--bg-primary)" }}>
