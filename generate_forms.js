...
const forms = [
  { name: 'BusinessLoanForm', type: 'Business Loan' },
  { name: 'VehicleLoanForm', type: 'Vehicle Loan' },
  { name: 'HousingLoanForm', type: 'Housing Loan' },
  { name: 'MovieFinancingForm', type: 'Movie Financing' },
  { name: 'PersonalLoanForm', type: 'Personal Loan' }
];
...
forms.forEach(form => {
  fs.writeFileSync(`components/forms/${form.name}.tsx`, generateTemplate(form.name, form.type));
  console.log(`Generated ${form.name}.tsx`);
});
