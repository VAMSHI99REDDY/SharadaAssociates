...
export default function PersonalLoanForm() {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (cleanData.monthlyIncome) cleanData.monthlyIncome = parseINR(cleanData.monthlyIncome);
  ...
  if (submitted) {
    return (
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center py-10 px-4">
        ...
        <h3 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-4">Personal Loan Application Submitted Successfully</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <input
            ...
            className={"input-field rounded-xl " + (errors.occupation ? "border-red-500 focus:ring-red-500" : "focus:border-green-500 focus:ring-green-500/20")} 
          />
            ...
            render={({ field: f }) => (
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g. 5,00,000"
                  className={"input-field pl-9 rounded-xl " + (errors.monthlyIncome ? "border-red-500 focus:ring-red-500" : "focus:border-green-500 focus:ring-green-500/20")}
                />
              </div>
            )}
          />
        ...
        <div>
          ...
          <input
            ...
            className={"input-field rounded-xl " + (errors.employerName ? "border-red-500 focus:ring-red-500" : "focus:border-green-500 focus:ring-green-500/20")} 
          />
          <ErrorMsg error={errors.employerName} />
        </div>
      </div>
