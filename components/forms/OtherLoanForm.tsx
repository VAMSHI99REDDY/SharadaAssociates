...
import { CheckCircle, Loader2, AlertCircle, Phone, Mail, Globe, ArrowLeft } from "lucide-react";
...
export default function OtherLoanForm({ loanType }: { loanType: string }) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            className={`input-field ${errors.fullName ? 'border-red-500 focus:ring-red-500' : 'focus:border-green-500 focus:ring-green-500/20'} rounded-xl`} 
          />
        ...
        <div>
          ...
          <input
            ...
            className={`input-field ${errors.phone ? 'border-red-500 focus:ring-red-500' : 'focus:border-green-500 focus:ring-green-500/20'} rounded-xl`} 
          />
        ...
        <div className="md:col-span-2">
          ...
          <input
            ...
            className={`input-field ${errors.email ? 'border-red-500 focus:ring-red-500' : 'focus:border-green-500 focus:ring-green-500/20'} rounded-xl`} 
          />
        ...
        <div>
          ...
          <input
            ...
            className={`input-field ${errors.businessName ? 'border-red-500 focus:ring-red-500' : 'focus:border-green-500 focus:ring-green-500/20'} rounded-xl`} 
          />
        ...
        <div>
          ...
          <select 
            ...
            className={`input-field ${errors.businessType ? 'border-red-500 focus:ring-red-500' : 'focus:border-green-500 focus:ring-green-500/20'} rounded-xl`}
          >
